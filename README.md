...
```text
https://raw.githubusercontent.com/filippobuletto/pihole-hoax-sites-list/main/coronavirus-misinformation-tracking-center.txt
```

## From [Bufale.net: THE BLACK LIST](https://www.bufale.net/the-black-list-la-lista-nera-del-web/)

```text
https://raw.githubusercontent.com/filippobuletto/pihole-hoax-sites-list/main/the-black-list-la-lista-nera-del-web.txt
```
...
```text
https://raw.githubusercontent.com/filippobuletto/pihole-hoax-sites-list/main/list-of-lists.txt
```
